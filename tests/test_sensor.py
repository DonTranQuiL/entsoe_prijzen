...
def mock_coordinator():
    ...
    coordinator.data = [
        ...
        {"timestamp_utc": "2026-05-19T12:00:00+00:00", "price_kwh": 0.18000}, # Current block
...
def test_current_price_sensor(mock_coordinator, mock_entry):
    ...
    with patch("custom_components.entsoe_prijzen.sensor.dt_util.utcnow", return_value=mock_now):
