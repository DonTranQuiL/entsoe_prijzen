...
def mock_cache_and_coordinator():
    ...
    with patch("custom_components.entsoe_prijzen.EntsoeCache") as mock_cache_cls, \
...
@pytest.mark.asyncio
async def test_async_setup_entry_no_cache(hass: HomeAssistant, mock_cache_and_coordinator):
...
@pytest.mark.asyncio
async def test_async_setup_entry_with_cache(hass: HomeAssistant, mock_cache_and_coordinator):
...
@pytest.mark.asyncio
async def test_services_and_update_listener(hass: HomeAssistant, mock_cache_and_coordinator):
