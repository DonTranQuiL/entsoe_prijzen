...
from custom_components.entsoe_prijzen.const import DOMAIN, CONF_API_TOKEN, CONF_DOMAIN_ID
...
@pytest.mark.asyncio
async def test_coordinator_first_run_uses_cache(hass: HomeAssistant, mock_entry, mock_cache):
...
async def test_coordinator_successful_update(mock_get_session, hass: HomeAssistant, mock_entry, mock_cache):
...
@pytest.mark.asyncio
@patch("custom_components.entsoe_prijzen.coordinator.async_get_clientsession")
async def test_coordinator_http_error(mock_get_session, hass: HomeAssistant, mock_entry, mock_cache):
...
@pytest.mark.asyncio
@patch("custom_components.entsoe_prijzen.coordinator.async_get_clientsession")
async def test_coordinator_parsing_exception(mock_get_session, hass: HomeAssistant, mock_entry, mock_cache):
